...
const port = 9335;
const profile = path.resolve('.chrome-mailbox-capture');
const outputDir = path.resolve('../../screenshots/mailbox-v1-implementation');
const pageUrl = 'http://127.0.0.1:4173/child/mailbox';
...
try {
  ...
  await capture(client, { width: 1440, height: 1024, mobile: false, file: 'mailbox-desktop-1440.png' });
  await capture(client, { width: 1024, height: 1024, mobile: false, file: 'mailbox-tablet-1024.png' });
  await capture(client, { width: 375, height: 812, mobile: true, file: 'mailbox-mobile-375.png' });
