...
const port = 9334;
const profile = path.resolve('.chrome-home-capture');
const outputDir = path.resolve('../../screenshots/home-v1-implementation');
const pageUrl = 'http://127.0.0.1:4173/child/home';
...
try {
  ...
  await capture(client, { width: 1440, height: 1024, mobile: false, file: 'home-desktop-1440.png' });
  await capture(client, { width: 1024, height: 1024, mobile: false, file: 'home-tablet-1024.png' });
  await capture(client, { width: 375, height: 812, mobile: true, file: 'home-mobile-375.png' });
