...
const port = 9333;
const profile = path.resolve('.chrome-dream-capture');
const outputDir = path.resolve('../../screenshots/dream-v1-implementation');
...
try {
  ...
  await capture(client, { width: 1440, height: 1024, mobile: false, file: 'dream-desktop-1440.png' });
  await capture(client, { width: 1024, height: 1024, mobile: false, file: 'dream-tablet-1024.png' });
  await capture(client, { width: 375, height: 812, mobile: true, file: 'dream-mobile-375.png' });
