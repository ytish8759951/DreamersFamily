...
function toSupabaseDream(dream: LocalDream): SupabaseDreamRow {
  return {
    ...
    cover_path: dream.cover_media_id ?? dream.coverMediaId ?? dream.cover_path ?? dream.coverUrl ?? dream.imageUrl ?? null,
...
function fromSupabaseDream(row: SupabaseDreamRow): LocalDream {
  return {
    ...
    cover_media_id: row.cover_path,
    coverMediaId: row.cover_path,
